        ...
        else if (PrivateConfig.MPUType == MPUTypeSPI)
        {
            ...
            if (Tmp_ICM20602_SPI_BufferX[1] & 0x01)
            {
                ...
                if (PrivateData._uORB_ICM60602_AccelCountDown >= (PrivateConfig.TargetFreqency / PrivateConfig.AccTargetFreqency))
                {
                    ...
                    std::cout<<"_uORB_ICM60602_A_Y"<<std::setw(7) << std::setfill(' ')<<PrivateData._uORB_ICM60602_A_Y<<"\r\n";
                    std::cout<<"_uORB_ICM60602_A_Z"<<std::setw(7) << std::setfill(' ')<<PrivateData._uORB_ICM60602_A_Z<<"\r\n";
                    std::cout<<"_uORB_ICM60602_A_X"<<std::setw(7) << std::setfill(' ')<<PrivateData._uORB_ICM60602_A_X<<"\r\n";
                    //
                ...
                PrivateData._uORB_ICM60602_AccelCountDown++;
                {
                    ...
                    std::cout<<"_uORB_ICM60602_G_Y"<<std::setw(7) << std::setfill(' ')<<PrivateData._uORB_ICM60602_G_Y<<"\r\n";
                    std::cout<<"_uORB_ICM60602_G_Z"<<std::setw(7) << std::setfill(' ')<<PrivateData._uORB_ICM60602_G_Z<<"\r\n";
                    std::cout<<"_uORB_ICM60602_G_X"<<std::setw(7) << std::setfill(' ')<<PrivateData._uORB_ICM60602_G_X<<"\r\n";
                    std::cout << "\033[6A";
                    std::cout << "\033[K";                    
                }
            }
